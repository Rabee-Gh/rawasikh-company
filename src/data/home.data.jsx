...
export const HERO_SLIDES = [
    {
        ...
        sub: "شركة تشغيلية تمتلك وتدير محفظة من العلامات التجارية الرائدة والمشاريع الواعدة عبر قطاعات أعمال متعددة وحيوية، مدعومة بحلول متكاملة ونظم أتمتة ذكية",
    ...
    },
    {
        ...
        headline: ['شفزار', 'تتوسع', 'في أحياء', 'جديدة بالرياض'],
        headlineAccent: [true, false, false, false],
        sub: 'علامتنا التجارية الرائدة في قطاع الأغذية والمشروبات تستهدف تغطية مواقع استراتيجية جديدة في مدينة الرياض لتصل تجربة الطعام الاستثنائية لشرائح أكبر.',
